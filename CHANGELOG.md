...
- Added the `car/` experiment folder: an `epsilon`-aware reproducible suite that measures approximation ratios against exact optima on feasible graphs and tests the `sqrt(2)` hypothesis.
